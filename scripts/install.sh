...
fail_trap() {
    ...
    if [ "$result" != "0" ]; then
        ...
        echo "For support, please file an issue in https://github.com/Augustu/micro/issues"
    fi
    cleanup
    exit $result
}
...
printInfo() {
    ...
    echo "To start contributing to micro please visit https://github.com/Augustu"
