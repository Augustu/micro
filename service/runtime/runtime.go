...
import (
	...
	"github.com/Augustu/micro/v2/service/runtime/manager"
	"github.com/Augustu/micro/v2/service/runtime/profile"
...
func Flags() []cli.Flag {
	return []cli.Flag{
		&cli.StringFlag{
			Name:  "source",
			Usage: "Set the source url of the service e.g github.com/Augustu/services",
		},
		&cli.StringFlag{
			Name:  "image",
...
func Commands(options ...micro.Option) []*cli.Command {
	command := []*cli.Command{
		...
		},
		{
			...
			micro run github.com/Augustu/examples/helloworld
			...
			micro run helloworld # deploy latest version, translates to micro run github.com/Augustu/services/helloworld
		...
		},
		{
			...
			Usage: UpdateUsage,
			Description: `Examples:
			micro update github.com/Augustu/examples/helloworld
			...
			micro update helloworld # deploy master branch, translates to micro update github.com/Augustu/services/helloworld
		...
		},
		{
			...
			Flags: Flags(),
			Description: `Examples:
			micro kill github.com/Augustu/examples/helloworld
			micro kill .  # kill service deployed from local folder
			micro kill ../path/to/folder # kill service deployed from local folder
			micro kill helloworld # kill serviced deployed from master branch, translates to micro kill github.com/Augustu/services/helloworld
