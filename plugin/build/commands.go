...
import (
	...
	goplugin "github.com/Augustu/go-micro/v2/plugin"
...
func build(ctx *cli.Context) error {
	...
	// set the path
	if len(path) == 0 {
		// github.com/Augustu/go-plugins/broker/rabbitmq
		// github.com/Augustu/go-plugins/micro/basic_auth
		path = filepath.Join("github.com/Augustu/go-plugins", typ, name)
	}
