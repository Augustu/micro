...
import (
	...
	gostore "github.com/Augustu/go-micro/v2/store"
	"github.com/Augustu/micro/v2/plugin"
	"github.com/Augustu/micro/v2/plugin/build"
	"github.com/Augustu/micro/v2/server"
	"github.com/Augustu/micro/v2/service"
	ccli "github.com/micro/cli/v2"

	// clients
	"github.com/Augustu/micro/v2/client/api"
	"github.com/Augustu/micro/v2/client/bot"
	"github.com/Augustu/micro/v2/client/cli"
	"github.com/Augustu/micro/v2/client/cli/new"
	"github.com/Augustu/micro/v2/client/cli/util"
	"github.com/Augustu/micro/v2/client/proxy"
	"github.com/Augustu/micro/v2/client/web"

	// services
	"github.com/Augustu/micro/v2/service/auth"
	"github.com/Augustu/micro/v2/service/broker"
	"github.com/Augustu/micro/v2/service/config"
	"github.com/Augustu/micro/v2/service/debug"
	"github.com/Augustu/micro/v2/service/health"
	"github.com/Augustu/micro/v2/service/network"
	"github.com/Augustu/micro/v2/service/registry"
	"github.com/Augustu/micro/v2/service/router"
	"github.com/Augustu/micro/v2/service/runtime"
	"github.com/Augustu/micro/v2/service/store"
	"github.com/Augustu/micro/v2/service/tunnel"

	// internals
	inauth "github.com/Augustu/micro/v2/internal/auth"
	"github.com/Augustu/micro/v2/internal/helper"
	"github.com/Augustu/micro/v2/internal/platform"
	_ "github.com/Augustu/micro/v2/internal/plugins"
	"github.com/Augustu/micro/v2/internal/update"
	_ "github.com/Augustu/micro/v2/internal/usage"
)
