...
func getLatestCommit() (string, error) {
	rsp, err := http.Get("https://api.github.com/repos/Augustu/micro/commits")
	if err != nil {
		return "", err
	}
...
func getLatestRelease() (string, error) {
	rsp, err := http.Get("https://api.github.com/repos/Augustu/micro/releases")
	if err != nil {
		return "", err
	}
	defer rsp.Body.Close()
...
func getLatestImage() (string, error) {
	rsp, err := http.Get("https://hub.docker.com/v2/repositories/Augustu/micro/tags/latest")
	if err != nil {
		return "", err
	}
	defer rsp.Body.Close()
